...
import com.example.myrecipeapp.databinding.ActivityNavigationTabBinding;
...
public class NavigationTab extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityNavigationTabBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());

        setSupportActionBar(binding.appBarNavigationTab.toolbar);
//        binding.appBarNavigationTab.fab.setOnClickListener(new View.OnClickListener() {
//            @Override
